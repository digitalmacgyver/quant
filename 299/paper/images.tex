...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay1938}%
$\displaystyle \rangle$%
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay1987}%
$\displaystyle \left.\vphantom{ \begin{array}{c} 
		w_{0} \\  
		w_{1} \\  
		\vdots \\  
...
$\displaystyle {\frac{{\partial |X(t) \rangle }}{{\partial t}}}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay2008}%
$\displaystyle {\frac{{\partial w_{i}(t)}}{{\partial t}}}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
