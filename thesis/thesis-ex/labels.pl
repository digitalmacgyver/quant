...
$key = q/cite_patterson98computer/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_grover00search/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_shor94algorithms/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_felsner92complexity/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_berthiaume97quantum/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_ibm01shor/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_chuang98quantum/;
$external_labels{$key} = "$URL/" . q|node57.html|; 
$noresave{$key} = "$nosave";
